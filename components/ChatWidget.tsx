...
// 1) stuur context naar n8n (freelancer gebruikt step + intent)
sendToN8n({
sessionId: sessionIdRef.current,
intent: "user_message",
step,
...
// 2) placeholder bot reply (optioneel: freelancer vervangt door echte response)
// typeBotMessage("Dank je! Ik kijk het meteen na 🙂", 8);
setUserInput("");
}}
style={{
width: 40,
